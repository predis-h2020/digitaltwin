...
def create_virtual_sensor_data(output_dir=None):
    ...
    param:
        output_dir: string
             The path where the files are to be stored, if empty, no files are stored
    ...
    metadata_sensor_1 = {
        "measuring_quantity": "temperature",
        "unit": "K",
    ...
    metadata_sensor_2 = {
        "measuring_quantity": "displacement",
        "unit": "m",
        "package": "test_package",
        "orientation": [1, 0, 0],
        "location": [5, 5, 5],
    ...
    raw_data_sensor_2 = {
        ...
        "displacement": np.linspace(start=1e-3, stop=5e-3, num=num_samples),
    }

    output_data["sensor_2"] = {
        "raw_data": raw_data_sensor_2,
        "meta_data": metadata_sensor_2,
    }
